...
public class Fragment_Dicover extends Fragment implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.txt_piaoliuping:
			...
			break;
		case R.id.txt_shop:
			Utils.start_Activity(getActivity(), PublicActivity.class, new BasicNameValuePair(Constants.NAME, getString(R.string.shopping)));
			break;
		case R.id.txt_game:
			Utils.start_Activity(getActivity(), PublicActivity.class, new BasicNameValuePair(Constants.NAME, getString(R.string.games)));
			break;
		default:
			break;
		}
